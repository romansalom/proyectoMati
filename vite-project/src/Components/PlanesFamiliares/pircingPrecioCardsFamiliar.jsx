import '../../App.css';
export const PrincingPriceCrdsFamiliar = () => {
  return (
    <div className="contenedore-zoom max-w-5xl mx-auto font-sans text-[#333]  mb-10">
      <br></br>
      <div className="flex justify-center items-center mx-auto mt-8  rounded-full max-w-[300px] p-1">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-y-8 mt-8 max-md:max-w-sm max-md:mx-auto">
        <div className="bg-white scale-[1.05] shadow-[0_4px_60px_-4px_rgba(93,96,127,0.6)]  rounded-3xl overflow-hidden p-8">
          <div className="text-left">
            <h4 className="text-2xl font-extrabold">StarterFAM</h4>
        ...
        <div className="bg-white scale-[1.05] shadow-[0_4px_60px_-4px_rgba(93,96,127,0.6)]  rounded-3xl overflow-hidden p-8">
          <div className="text-left">
            <h4 className="text-2xl font-extrabold">Professional FAM</h4>
        ...
        <div className="bg-white scale-[1.05] shadow-[0_4px_60px_-4px_rgba(93,96,127,0.6)]  rounded-3xl overflow-hidden p-8">
          <div className="text-left">
            <h4 className="text-2xl font-extrabold">Enterprise FAM</h4>
